...
Prior to running the program, please make sure that the client file (main.cpp), implementation files (nodeImp.cpp, gameImp.cpp, linkedListImp.cpp), and header files (node.h, game.h, linkedList.h), are placed in the same directory/folder. 
